            ...
            <nav className="navbar navbar-expand-lg navbar-light py-3 mx-auto mb-5 sticky-top" id={`${styles.primaryNav}`} style={{ backgroundColor: color }}>
                <div className="container-fluid d-flex justify-content-between">
                    <Link to="/" className={`${styles.thumbnailLink}`}>
                        <img src="src/assets/logo_nav.webp" alt="" className={`${styles.logo} mx-0`} style={{ width: '100px', height: '100px' }} />
                    </Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className={` nav-item mx-3`}>
                                <Link className={`${styles.iconHover} ${styles.iconContainer} nav-link`} aria-current="page" to="/" style={{ color: txColor }}>
                                    <i className="fa-solid fa-house"></i>
                                    <span className={`${styles.iconText}`}>Trang chủ</span>
                                </Link>
                            </li>
                            <li className="nav-item mx-3 dropdown">
                                <a className={`${styles.iconHover} ${styles.iconContainer} nav-link dropdown-toggle`} href="#" id="colorDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ color: txColor }}>
                                ...
                                <ul className="dropdown-menu" aria-labelledby="colorDropdown">
                                    {backgroundColorList.map((colorObj, index) => (
                                        <ChangeBackgroundColor key={index} color={colorObj.bg_color} txColor={colorObj.text_color} setColor={setColor} setTxColor={setTxColor} />
                                    ))}
                                </ul>
                            </li>
                            {Boolean(user) ? (
                                <>
                                    ...
                                    <a onClick={handleLogout} className={`${styles.iconHover} ${styles.iconContainer}`}>
                                ...
                                <li className="nav-item mx-3">
                                    <a className={`${styles.iconHover} ${styles.iconContainer} nav-link dropdown-toggle`} href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ color: txColor }}>
                                        <i className="fa-solid fa-user"></i>
                                        <span className={`${styles.iconText}`}>Tài khoản</span>
                                    </a>
                                    <ul className="dropdown-menu" aria-labelledby="accountDropdown">
                                        <li><Link className="dropdown-item" to="/signIn"><i className="fa-solid fa-arrow-right-to-bracket"></i> Đăng nhập</Link></li>
                                        <li><Link className="dropdown-item" to="/signUp"><i className="fa-solid fa-arrow-turn-up"></i> Đăng ký</Link></li>
                                    </ul>
                                </li>
                            )}
                            <li className="nav-item mx-3 dropdown">
                            ...
                            <li className="nav-item mx-3">
                                <Link className={`${styles.iconHover} ${styles.iconContainer} nav-link active`} aria-current="page" to="/addToCart" style={{ color: txColor }}>
                        ...
                        <form className="d-flex">
                            ...
                            <button className="btn btn-outline-success" type="submit" style={{ color: txColor }}>
